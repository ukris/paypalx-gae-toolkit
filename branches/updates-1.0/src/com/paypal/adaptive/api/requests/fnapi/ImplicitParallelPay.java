...
/**
 * Java class to send implicit Parallel payment.
 *
 */
public class ImplicitParallelPay {
     ...
     * Default constructor
     */
    public ImplicitParallelPay(int numberOfReceivers) throws NotEnoughReceivers{
