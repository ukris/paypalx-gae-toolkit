...
public class GetPaymentOptionsRequest {
    ...
    public GetPaymentOptionsResponse execute(APICredential credentialObj) throws MissingParameterException, InvalidResponseDataException, RequestFailureException, IOException  {
